...
public class PlayerMovement : MonoBehaviour
{
    ...
    private Vector2 lastMovement; // Tracks the last direction the player moved in
    ...
    // Lifestyle method called when script is loaded - BEFORE any Start methods
    void Awake()
    {
        controls = new PlayerControls(); // Initializes controls object, handles player input, comes from Unity's Input System package
    ...
    // Called when object is enabled/active - enables control system
